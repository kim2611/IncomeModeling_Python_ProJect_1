...
def Header(name, app):
    ...
    return html.Div(
        [
            ...
            html.A(fcseoul_logo, href="https://m.fcseoul.com/"),
            html.A(sisul_logo, href="https://www.sisul.or.kr/open_content/main/"),
            html.A(kma_logo, href="https://www.weather.go.kr/w/index.do"),
